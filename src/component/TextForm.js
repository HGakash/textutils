...
<div className="container"  style={{color:props.mode==='dark'?'white':'#161515'}}>
 ...
 <button className='btn btn-primary my-3 mx-2'  onClick={handleClick}>convert to uppercase</button>
 <button className='btn btn-primary my-3' onClick={handleLower}>convert to lowercase</button>
 ...
 <button className='btn btn-primary my-3 mx-2' onClick={hadnleExtraSpaces}>remove space</button>
